...
<body>
  <div class="grid">
    ...
    <br><br><br><h1 class="text" id="welcome"align = "center">அனைத்து உறுப்பினர்களின் லிஸ்ட்</h1><br><br>
    <form action ="allmemberinfo.php" method = "post" autocomplete="off">
    <fieldset style='width:auto;margin:auto;' class='members'>
      ...
      <div class="row">
          ...
          height:40px;"><option value = "all">All</option>
          </select></label></div>
